...

{
    ...
    'assets': {
        'web.assets_backend': [
            'simplify_access_management_18/static/src/js/action_menus.js',
            'simplify_access_management_18/static/src/js/hide_chatter.js',
            'simplify_access_management_18/static/src/js/cog_menu.js',
            'simplify_access_management_18/static/src/js/form_controller.js',
            'simplify_access_management_18/static/src/js/model_field_selector.js',
            'simplify_access_management_18/static/src/search_menu_patch/search_menu_patch.js',
        ],
    ...
    'depends': ['web', 'advanced_web_domain_widget_original_18'],
