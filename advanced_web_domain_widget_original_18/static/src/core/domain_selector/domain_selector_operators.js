...
import { formatValue, toValue } from "@advanced_web_domain_widget_original_18/core/domain_tree";
import { sprintf } from "@web/core/utils/strings";
import { parseExpr } from "@web/core/py_js/py";

/**
 * @typedef {Object} OperatorInfo
 * @property {import("@advanced_web_domain_widget_original_18/core/domain_tree").Value} operator
...
/**
 * @param {import("@advanced_web_domain_widget_original_18/core/domain_tree").Value} operator
...
/**
 * @param {import("@advanced_web_domain_widget_original_18/core/domain_tree").Value[]} operators
 * @returns {(OperatorInfo)[]}
 */
